...
! function () {
  ...
  var e = window.document,
    ...
    A = function (e, t, o) {
      ...
      if (f.length < l.length || ("." + f).substring(f.length - l.length) !== "." + l) return c.removeAttribute("href"), void o(d);
      var h = (" /" + c.pathname).split(/\/+/);
      if (((f === l || f === "gist." + l) && "archive" === h[3] || f === l && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || f === "codeload." + l) && (c.target = "_top"), "true" === w(t["data-show-count"]) && f === l) {
        var u, g;
